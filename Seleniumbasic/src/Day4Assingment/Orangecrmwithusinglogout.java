...
public class Orangecrmwithusinglogout {
	...
	public static void main(String[] args) {
		...
		System.out.println("Page URL status: "+pageURL.equals("https://opensource-demo.orangehrmlive.com/web/index.php/auth/login"));
